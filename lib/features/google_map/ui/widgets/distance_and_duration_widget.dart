...
class PositionedDistanceAndDurationWidget extends StatelessWidget {
  const PositionedDistanceAndDurationWidget({
    super.key, this.top, this.bottom, this.left, this.right, required this.isDistance, required this.icon,
  });
  final double? top;
  final double? bottom;
  final double? left;
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(isDistance ? '${cubit.distanceInKm!.toStringAsFixed(0)} km' : '${cubit.durationInMinutes!.toStringAsFixed(0)} min' , style: const TextStyle(fontSize: 15 , fontWeight: FontWeight.w500),),
                  ],
                ),
              ),
            ),
